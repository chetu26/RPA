...
namespace LoggingLibrary
{
    public static class LoggingManager
    {
        ...
        {
            LogManager.GetLogger(type.FullName).Error(exception, $"Inner Exception : {exception.InnerException?.StackTrace}. Message : {message}");
        }
        ...
        {
            LogManager.GetLogger(type.FullName).Fatal(exception, message);
        }
    }
}
